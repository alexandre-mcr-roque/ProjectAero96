        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelNameShort = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    ...
                    SeatColumns = table.Column<byte>(type: "tinyint", nullable: false),
                    WindowSeats = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    Airline = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(255)", nullable: false),
                    AirlineImageId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChildPricePercentage = table.Column<byte>(type: "tinyint", nullable: false),
                    BabyPricePercentage = table.Column<byte>(type: "tinyint", nullable: false),
